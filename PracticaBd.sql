...
foreign key (correo_e) references Expertos
);
...
insert into Expertos values ('atn_perz@hotmail.es', 3);
insert into Expertos values ('ner_lla@hotmail.com', 2);
insert into Expertos values ('adebar@yahoo.com', 4);
insert into Expertos values ('dorga@gmail.com', 1);
insert into Expertos values ('luichan@ucm.es', 5);
insert into Expertos values ('jhon_hutten@hotmail.ge', 2);
insert into Expertos values ('alScot@hotmail.com', 1);
insert into Expertos values ('felSanto@gmail.com', 3);
insert into Expertos values ('loneMc@hotmail.com', 4);
insert into Expertos values ('soficas@gmail.es', 3);
...
begin 
	...
	loop
		...
		dbms_output.put_line ( 'Número: ' || v_num ||'Título: ' || v_titulo || 'Pntuación: ' || media || 'Decisión: ' || v_acept);
		v_aux := v_num;
